...
1. 우선 `bs4`와 `selenium`, `webdriver-manager`가 필요합니다. 필요에 따라 루트 디렉토리에서 `venv`를 구성하셔도 좋습니다.

		$ pip install bs4
		$ pip install selenium
		$ pip install webdriver-manager

2. `config.json`을 구성합니다. 이 파일은 프로젝트 **루트 디렉토리**에 저장하세요. 다음과 같이 작성합니다.
...
**news2atc**는 `python`으로 개발되어 Windows는 물론 Linux, macOS와 같은 다양한 플랫폼에서 실행할 수 있습니다. 다음과 같은 프로그램 및 라이브러리가 필요합니다.  
 ...
 - `webdriver-manager` : 웹 드라이버를 **python** 코드 상에서 쉽게 관리합니다.
 - [**Chrome Browser**](https://www.google.com/intl/ko/chrome/)  
